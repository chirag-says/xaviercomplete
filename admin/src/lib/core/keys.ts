 ...
 *
 * COPIED from oxvercity/src/lib/core/keys.ts to make the admin app
 * self-contained for separate Hostinger hosting. Keep in sync manually
 * until a shared packages/core workspace is set up.
 */
